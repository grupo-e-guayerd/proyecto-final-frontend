...
export default class AboutUsPage extends Component {
  ...
  componentDidMount() {
    ...
    fetch(/* URL Server */)
      ...
      .then((jsonString) => {
        this.setState({ ourDescription: jsonString });
      })
      .catch((error) => {
        /* TODO chatch handler */
      });
        ...
        <div className="aboutUs-container">
          <div data-aos="fade-up" className="aboutUs-nosotros">
            ...
            <p className="our-description">
              ...
              sem non nisi suscipit pharetra et at turpis. Morbi efficitur
              mollis finibus. Donec condimentum est purus. Vestibulum eget
              fermentum ligula.Lorem ipsum dolor sit amet, consectetur
              adipiscing elit. Aenean et sem non nisi suscipit pharetra et at
              turpis. Morbi efficitur mollis finibus. Donec condimentum est
              purus. Vestibulum eget fermentum ligula.
              <br></br>
            </p>
            ...
            <p className="our-description">
              ...
              sem non nisi suscipit pharetra et at turpis. Morbi efficitur
              mollis finibus. Donec condimentum est purus. Vestibulum eget
              fermentum ligula. Sed quis velit in libero cursus congue. Integer
              viverra viverra enim consequat convallis. Suspendisse id mauris
              rutrum, rutrum odio a, pretium urna. Proin dictum id quam sed
              laoreet. Curabitur volutpat urna justo, sit amet egestas risus
              cursus egestas. Nullam eget turpis tempor, vehicula urna in, porta
              ligula. Proin efficitur lacinia elit, sit amet dapibus nulla
              fringilla sit amet. Aliquam quis convallis purus. Aliquam mollis
              ac augue non sodales. Curabitur suscipit tristique diam eget
              maximus. Duis ut metus sit amet nulla laoreet volutpat.
              <br></br>
            </p>
            <p className="our-description">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean et
            ...
            <div data-aos="fade-up" className="aboutus-container">
              <div className="aboutUs-info-card">
                ...
                <p>
                  ...
                  Aenean et sem non nisi suscipit pharetra et at turpis. Morbi
                  efficitur mollis finibus. Donec condimentum est purus.
                  Vestibulum eget fermentum ligula.{" "}
                </p>
              </div>
            ...
            <div className="equipo-container">
              <div className="equipo-integrante">
                ...
                <div className="integrante-info">
                  <h3 className="integrante-nombre">Juan Carlos Viale</h3>
              ...
              <div className="equipo-integrante">
                ...
                <div className="integrante-info">
                  <h3 className="integrante-nombre">Bill Gates</h3>
                  <h4 className="integrante-puesto">Lorem ipsum </h4>
                  <p className="integrante-descripcion">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  </p>
              ...
              <div className="equipo-integrante">
                ...
                <div className="integrante-info">
                  <h3 className="integrante-nombre">Jorge López</h3>
                  <h4 className="integrante-puesto">Lorem ipsum </h4>
                  <p className="integrante-descripcion">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  </p>
              ...
              <div className="equipo-integrante">
                ...
                <div className="integrante-info">
                  <h3 className="integrante-nombre">Fabio Poska</h3>
                  <h4 className="integrante-puesto">Lorem ipsum </h4>
                  <p className="integrante-descripcion">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  </p>
