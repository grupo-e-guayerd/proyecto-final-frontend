      ...
      <footer className="footerGeneral">
        <div className="footer-up">
          <div className="footer-nav-menu">
            ...
            <NavLink exact to="/servicios" className="footer-nav-menu-item">
              SERVICIOS
            </NavLink>
            <NavLink exact to="/nosotros" className="footer-nav-menu-item">
              NOSOTROS
            </NavLink>
            <NavLink exact to="/login" className="footer-nav-menu-item">
              INGRESAR
            </NavLink>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-title">
            <h6>Servioficios | Copyright&copy; {new Date().getFullYear()}</h6>
          </div>
        </div>
      </footer>
    );
