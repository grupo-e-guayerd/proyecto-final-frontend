...
export default class AboutUsPage extends Component
{
    constructor() {
        ...
        this.state = {
            ...
            ourDescription: "Somos un grupo de estudiantes unidos por la pasión de programar que a partir de la necesidad de realizar un cambio en la manera de contratar servicios de oficio pensamos en (nombre de la empresa).(Nombre de la empresa) nace de la necesidad de dar una respuesta a aquellas personas que necesitan de un servicio de algún oficio y no tener ninguna referencia. Los queremos acompañar: ¿No te ha pasado que necesitaste alguna persona que venga a tu casa a hacer un arreglo y no saber a quien recurrir? ¿o experimentar que te han recomendado una persona pero no tenes muchas mas referencias? Si te sentís identificado, estas en el lugar correcto.(Nombre de la empresa) conecta a las personas que ofrecen oficios con alguien como vos que necesita de ellos. Es muy fácil, solo tenes que seleccionar al profesional que necesitas y nosotros hacemos el resto. Sumate a la nueva forma de de contratar un oficio."
        }
    }
